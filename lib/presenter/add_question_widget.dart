              ...
              child: ListView(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Invalid Answer #1'),
                    validator: (String? value) {
                      return (value == null || value.isEmpty)
                          ? 'Please enter an invalid answer'
                          : null;
                    },
                  ),
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Invalid Answer #2'),
                    validator: (String? value) {
                      return (value == null || value.isEmpty)
                          ? 'Please enter an invalid answer'
                          : null;
                  ...
                  TextFormField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Invalid Answer #3'),
                    validator: (String? value) {
                      return (value == null || value.isEmpty)
                          ? 'Please enter an invalid answer'
                          : null;
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        List<String> incorrectAnswers = [
                          incorrectAnswerOneController.text,
                          incorrectAnswerTwoController.text,
                          incorrectAnswerThreeController.text
                        ];
